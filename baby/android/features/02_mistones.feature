...
Feature: Milestones
  ...
  @milestone_4m @regression
    Scenario: verify milestone list by end of month 2, 4, 6, 9 and 12
    Given I create a new father with 1 born girl whose birthday is "2.months.ago.yesterday"
    And I login
    And I open all moments
  ...
  @milestone_6m
    Scenario: verify milestone list by end of month 2, 4, 6, 9 and 12
    Given I create a new father with 1 born girl whose birthday is "4.months.ago.yesterday"
    And I login
    And I open all moments
  ...
  @milestone_9m
    Scenario: verify milestone list by end of month 2, 4, 6, 9 and 12
    Given I create a new father with 1 born girl whose birthday is "6.months.ago.yesterday"
    And I login
    And I open all moments
  ...
  @milestone_12m
    Scenario: verify milestone list by end of month 2, 4, 6, 9 and 12
    Given I create a new father with 1 born girl whose birthday is "9.months.ago.yesterday"
    And I login
    And I open all moments
  ...
  @milestone_13m
    Scenario: verify milestone list by end of month 2, 4, 6, 9 and 12
    Given I create a new father with 1 born girl whose birthday is "12.months.ago.yesterday"
    And I login
    And I open all moments
    And I should see "Is shy or nervous with strangers"
    And I close moments page
