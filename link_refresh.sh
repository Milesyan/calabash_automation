...
do
  ...
  rm -r ${APP}/android/scripts/*.sh
  rm -r ${APP}/ios/scripts/*.sh
  rm -r ${APP}/www/Gemfile
  ...
  ln common/android/scripts/* ${APP}/android/scripts
  ln common/ios/scripts/* ${APP}/ios/scripts
  ln common/www/Gemfile ${APP}/www/Gemfile
done