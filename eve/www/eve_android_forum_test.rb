...
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/group/#{group_id}/topic?#{@additional_forum}"
...
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/topic/#{topic_id}/vote?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
#       if @res["rc"] == 0
...
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/topic/#{topic_id}/reply?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "group_id": group_id
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/group/subscribe?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "group_id": group_id
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/group/unsubscribe?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#       group_data = {
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/user/0/groups?#{@additional_forum}"
...
#       data = {}
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/topic/#{topic_id}?#{@additional_forum}"
...
#         "empty_stub": ""
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/user/#{user_id}/unfollow?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "empty_stub": ""
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/user/#{user_id}/block?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "empty_stub": ""
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/user/#{user_id}/unblock?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "bookmarked": 1
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/topic/#{topic_id}/bookmark?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "liked": 1
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/topic/#{topic_id}/like?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "disliked": 1
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/topic/#{topic_id}/dislike?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "liked": 1
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/reply/#{reply_id}/like?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#         "disliked": 1
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/reply/#{reply_id}/dislike?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
...
#       }
#       url = "#{EVE_ANDROID_BASE_FORUM_URL}/topic/#{topic_id}/flag?#{@additional_forum}"
#       @res = HTTParty.post(url, :body => data.to_json, :headers => { "Authorization" => @ut , 'Content-Type' => 'application/json' }) 
