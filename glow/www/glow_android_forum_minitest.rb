...
class GlowTest < Minitest::Test
  ...
  def test_community_create_anonymous_topic
    u = forum_new_user.complete_tutorial
  ...
  def test_community_vote_poll
    u = forum_new_user.complete_tutorial.create_poll :group_id => 1,:topic_title => "Test vote poll"
    u.vote_poll :topic_id => u.topic_id, :vote_index => 3 
    assert_rc u.res
  end

  def test_community_vote_poll_repeatedly
    u = forum_new_user.complete_tutorial.create_poll :topic_title => "Test vote poll"
    u.vote_poll :topic_id => u.topic_id, :vote_index => 3
    assert_rc u.res
    u2 = forum_new_user.complete_tutorial
  ...
  def test_post_image
    u = forum_new_user.complete_tutorial.join_group
    u.create_photo
    assert_rc u.res
  end
